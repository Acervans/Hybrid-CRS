...
COMMENT ON TABLE "public"."KeepAlive" IS 'Auxiliary table to keep the project alive using Cron integration';



ALTER TABLE "public"."KeepAlive" ALTER COLUMN "count" ADD GENERATED BY DEFAULT AS IDENTITY (
...
ALTER TABLE ONLY "public"."KeepAlive"
    ADD CONSTRAINT "KeepAlive_pkey" PRIMARY KEY ("count");
...
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "public"."KeepAlive" TO "anon";
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "public"."KeepAlive" TO "authenticated";
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "public"."KeepAlive" TO "service_role";
